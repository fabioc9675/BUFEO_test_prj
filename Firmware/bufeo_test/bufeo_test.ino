...
volatile uint8_t flagPot = false;
...
uint16_t Period = 0;
uint16_t contPeriod = 0;
uint16_t activePeriod = 0;
volatile uint8_t flagActive = false;
...
void setup()
{
	...
	xTaskCreatePinnedToCore(task_Turbine, "task_Turbine", 2048, NULL, 1, NULL, taskCoreOne);
