...
extern volatile uint8_t flagPot;
...
void switchRoutine(void)
{
    ...
    case CONFIG_MENU:
        ...
        else
        {
            ...
            {
                flagPot = !flagPot;
                currentPotencia = newPotencia;
            }

            Serial.print(currentFrecRespiratoria);
            Serial.print(", ");
            Serial.print(currentRelacionIE);
            Serial.print(", ");
            Serial.println(currentPotencia);
        }
        break;
    // case VENT_MENU:
    //     if (optionVentMenu == 0)
